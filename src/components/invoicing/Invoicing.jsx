  ...
  return (
    <div className="i">
        <div className="i-wrapper">
            ...
            <p className="i-p">
              <span className="redText">All pricing is subject to change at any time based on current 
              ...
              <br /><br />
              Payments are due in full to <span className="redText">(ATR Air Tool Repair LLC)</span> upon delivery of repaired tools. 
